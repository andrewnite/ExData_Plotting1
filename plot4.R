...
par(mfrow = c(2,2))
with(filteredPowerConsumptionData, {
    plot(Date_time, as.numeric(Global_active_power),type="l",xlab="",ylab="Global Active Power (kilowatts)")
    ...
    legend("topright", lty = c(1,1), bty="n", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col=c("black", "red", "blue"))
